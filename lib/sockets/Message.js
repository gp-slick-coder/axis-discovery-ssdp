...
class Message {
    ...
    get location() {
        var _a;
        return (_a = this.getHeaderValue('LOCATION')) !== null && _a !== void 0 ? _a : this.getHeaderValue('Location');
    }
    /**
    ...
    getHeaderValue(headerName) {
        ...
        // We can not do this check, every device can have a different format.
        // if (!headerValue) {
