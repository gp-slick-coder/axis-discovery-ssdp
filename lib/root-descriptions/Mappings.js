...
function mapFromRootDescription(rootDescription) {
    ...
    //     return null;
    // }
    return new __1.Device(rootDescription.remoteAddress, parsePortFromPresentationUrl(rootDescription.presentationUrl), rootDescription.macAddress, rootDescription.friendlyName, rootDescription.modelName, rootDescription.modelDescription, rootDescription.modelNumber, rootDescription.presentationUrl);
}
exports.mapFromRootDescription = mapFromRootDescription;
const portFromPresentationUrlRegExp = /:(\d+)\/?$/i;
function parsePortFromPresentationUrl(presentationUrl) {
